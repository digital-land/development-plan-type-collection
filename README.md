# Development Plan Type collection

[![License](https://img.shields.io/github/license/mashape/apistatus.svg)](https://github.com/digital-land/development-plan-type/blob/master/LICENSE)

A collection of Development Plan Type.

The national dataset is in a format consistent with other Digital Land datasets as defined by the [development-plan-type schema](https://digital-land.github.io/specification/schema/development-plan-type/).
